...
def test_get_account_balance_uses_v2_path(monkeypatch) -> None:  # type: ignore[no-untyped-def]
    ...
    assert captured["path"] == "/v2/relay_account/0x1111111111111111111111111111111111111111/balance"
